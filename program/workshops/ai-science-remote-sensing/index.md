...
<section class="section">
  <!-- <div class="section-grid"> -->
    ...
    <div class="section-body">
      <p> <strong> 9am-5pm on May 25 2026, <a href="https://roomfinder.sfu.ca/apps/sfuroomfinder_web/?q=HAL%20126">Halpern Centre 126</a> </strong> </p>
    ...
    <div class="section-body">
      <div class="program-overview-list">
        ...
        <div class="program-overview-card is-plain">
          ...
          <div class="program-overview-meta">
            <p><strong>Time:</strong> 10:10am-10:30am</p>
          </div>
        </div>
        <div class="program-overview-card">
          <div>
        ...
        <div class="program-overview-card">
          <div>
            <p class="program-overview-title">Lightning Talks 1</p>
          </div>
          <div class="program-overview-meta">
            <p><strong>Time:</strong> 11:00am-11:20am</p>
          </div>
        </div>
        <div class="program-overview-card">
          <div>
        ...
        <div class="program-overview-card">
          <div>
            <p class="program-overview-title">Lightning Talks 2</p>
          </div>
          <div class="program-overview-meta">
            <p><strong>Time:</strong> 13:30pm-13:50pm</p>
          </div>
        </div>
        <div class="program-overview-card">
          <div>
            <p class="program-overview-title">Poster Session 2</p>
          </div>
          <div class="program-overview-meta">
            <p><strong>Time:</strong> 13:50pm-14:30pm</p>
          </div>
        </div>
        <div class="program-overview-card is-plain">
          <div>
          ...
          <div class="program-overview-meta">
            <p><strong>Time:</strong> 14:30pm-15:00pm</p>
          </div>
        </div>
        <div class="program-overview-card">
          <div>
        ...
        <div class="program-overview-card">
          <div>
            <p class="program-overview-title"> Panel Discussion incl. Speakers + Chris Rampersad (EarthDaily)</p>
          </div>
          <div class="program-overview-meta">
        ...
        <div class="program-overview-card is-plain">
          <div>
            <p class="program-overview-title"> Bonus / Overflow Time for Conversation</p>
          </div>
          <div class="program-overview-meta">
            <p><strong>Time:</strong> 16:45pm-17:00pm</p>
          </div>
        </div>         
      </div>
    </div>
...
<section class="section">
  <!-- <div class="section-grid"> -->
    ...
    <div class="section-body">
      ...
      <p> <strong> <a href="https://forms.gle/DnHdVSCt4twJwnjs8"> Submit your poster or lightning talk by May 20! </a> </strong> </p>
      <p> Posters and Lightning Slides will be posted here closer to the event. </p>
    </div>
  <!-- </div> -->
</section>
